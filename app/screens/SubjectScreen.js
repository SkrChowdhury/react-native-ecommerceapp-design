  ...
  const getSubjects = async () => {
    try {
      const response = await fetch(
        "https://gist.githubusercontent.com/SkrChowdhury/670b875411132206615a7f0e64c6daef/raw/ff9f92b4486bda7f0f481b15a66050e6096d776f/subjects.json"
      );
                ...
                >
                  <Text
                    style={[
                      ...
                      tab.tab1 && styles.tabButtonTitleActive
                    ]}
                  >
                    {item.subject}
                  </Text>
                  ...
                  <TouchableOpacity>
                    <View
                      style={{
                        height: 180,
                        width: 170,
                        backgroundColor: "rgb(111,223,143)",
                        borderRadius: 20,
                        marginRight: 20
                      }}
                    >
            ...
            <TouchableOpacity>
              <View
                style={{
                  height: 180,
                  width: 170,
                  backgroundColor: "rgb(100,200,254)",
                  borderRadius: 20,
                  marginRight: 20
                }}
              >
